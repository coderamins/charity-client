        ...
        <div className="flex h-screen">
            ...
            <div className="w-1/2 flex flex-col justify-center items-center bg-blue-100 p-10 relative">
                ...
                <div className="relative z-10">
                    <h1 className="text-3xl font-bold text-gray-700 mb-4">به خیریه ما خوش آمدید</h1>
            ...
            <div className="w-1/2 flex flex-col justify-center items-center p-10">
                ...
                <form className="w-full max-w-sm">
                    ...
                    <button className="w-full bg-blue-600 text-gray-600 py-3 rounded-lg hover:bg-blue-700 transition">ورود</button>
                </form>
                <p className="mt-4 text-gray-600">
                    حساب ندارید؟ <a href="#" className="text-blue-500">ثبت نام کنید</a>
                </p>
            </div>
        </div>
    );
